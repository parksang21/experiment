...
class OpenTestMNIST(torchvision.datasets.MNIST):
    def __init__(self, 
                 root: str='/datasets',
                 train: bool=False,
        ...
        super(OpenTestMNIST, self).__init__(root, train=train, transform=transform, 
...
class SplitMNIST(torchvision.datasets.MNIST):
    def __init__(self,
        ...
        super(SplitMNIST, self).__init__(root, train=train, transform=transform,
